...
describe 'pdk new class', module_command: true do
  context 'in a new module' do
    ...
    context 'when creating the main class', :audit_risk => :low, :audit_layer => :integration do
    ...
    context 'when creating an ancillary class', :audit_risk => :high, :audit_layer => :integration do
    ...
    context 'when creating a deeply nested class', :audit_risk => :high, :audit_layer => :integration do
